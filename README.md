...
| **참여자** | **기사 제목**                  | **링크**      | **한 줄 평**                       |
|------------|--------------------------------|---------------|------------------------------------|
| 김명훈       | Will 2025 Be the Year Real-Time Analytics Finally Goes Mainstream? | [Link](https://medium.com/towards-data-science/will-2025-be-the-year-real-time-analytics-finally-goes-mainstream-74556ab7cd8c) | 2025는 실시간 데이터의 해가 될 것이다. 관련해서 카프카에대한 공부가 필요한 해가 되어야 할것 같다. |
| 김명훈       | Top 10 Java Open-Source Projects on GitHub | [Link](https://medium.com/@lreverchuk/top-10-java-open-source-projects-on-github-f75755d1a14a) | 자바의 유용한 오픈 소스 라이브러리, 자바에서 BitcoinJ라는것이 있다? |
